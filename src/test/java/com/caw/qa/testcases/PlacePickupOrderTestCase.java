...
public class PlacePickupOrderTestCase extends TestBase {
	...
	public void placePickupOrderAsGuestUserWithGiftCard(String locationName, String orderType, String menuname,
			String itemname, String addonName, String optionName, String tipAmount, String fname, String lname,
			String emailId, String cnfEmail, String phNo, String mobNo, String faxNo, String comment,
			String paymentType, String cardNum, String expDate, String firstName, String lastName, String cvv,
			String zipcode, String giftcardNum, String giftPinNum, String billingadd1, String stateName, String cityb,
			String zipc) throws InterruptedException {
		...
		checkoutpage.makePaymentForGuestUsers(paymentType, cardNum, expDate, firstName, lastName, cvv, zipcode, giftcardNum,
				giftPinNum, billingadd1, stateName, cityb, zipc);
	...
	@Test(enabled = false)
	public void placeorderByLoginUser() {
